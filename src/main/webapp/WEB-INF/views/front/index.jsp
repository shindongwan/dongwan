...
<%@include file="header.jsp"%>
						  ...
						  <ul class="resp-tabs-list">
							...
							<div class="resp-tabs-container">
							    <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
									<div class="facts">
									 <img src="../../../resources/images/abt-img.PNG" alt="" />  
							      ...
							      <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
									<div class="facts">
									  <img src="../../../resources/images/abt-4.png" alt="" />
							      ...
							      <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
									<div class="facts">
									  <img src="../../../resources/images/abt-2.png" alt="" />
							     ...
							     <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">
									<div class="facts">
									  <img src="../../../resources/images/abt-3.png" alt="" />
	...
	<div class="special">
		...
		<div class="special-bottom">
			...
			<div class="col-md-6 special-bottom-left">
						<a href="gallery" class="b-link-stripe b-animate-go  thickbox">
									<img class="port-pic" class="img-responsive" src="../../../resources/images/one-2.jpg" />
									<div class="b-wrapper">
										<h2 class="b-animate b-from-left b-from   b-delay03 ">
											<img src="../../../resources/images/spl-img.png" alt="">
											<span>normal distribution of letters, as opposed to using 'Content here, content here',</span>
			...
			<div class="col-md-6 special-bottom-left">
						<a href="gallery" class="b-link-stripe b-animate-go  thickbox">
									<img class="port-pic" class="img-responsive" src="../../../resources/images/one-3.jpg" />
									<div class="b-wrapper">
										<h2 class="b-animate b-from-left b-from   b-delay03 ">
											<img src="../../../resources/images/spl-img.png" alt="">
											<span>normal distribution of letters, as opposed to using 'Content here, content here',</span>
			...
			<div class="col-md-6 special-bottom-left">
						<a href="gallery" class="b-link-stripe b-animate-go  thickbox">
									<img class="port-pic" class="img-responsive" src="../../../resources/images/one-4.jpg" />
									<div class="b-wrapper">
										<h2 class="b-animate b-from-left b-from   b-delay03 ">
											<img src="resources/images/spl-img.png" alt="">
											<span>normal distribution of letters, as opposed to using 'Content here, content here',</span>
			...
			<div class="news-top">
				...
				<div class="news-bottom">
					<div class="col-md-4 news-bottom-left">
						<img src="../../../resources/images/news-1.jpg" alt=""> 						 
					...
					<div class="col-md-4 news-bottom-left">
						<img src="../../../resources/images/news-2.jpg" alt="">
						<p>Maecenas ut nunc auctor urna vestibulum cursus</p>
						<div class="news-btn">
							<a href="#">Readmore</a>
						</div>
					...
					<div class="col-md-4 news-bottom-left">
						<img src="../../../resources/images/news-3.jpg" alt="">
						<p>Maecenas ut nunc auctor urna vestibulum cursus</p>
						<div class="news-btn">
							<a href="#">Readmore</a>
						</div>
